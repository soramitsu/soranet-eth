...
package jp.co.soramitsu.soranet.eth.deposit
...
import jp.co.soramitsu.soranet.eth.deposit.endpoint.EthAddPeerStrategyImpl
import jp.co.soramitsu.soranet.eth.deposit.endpoint.EthServerEndpoint
...
class EthDepositInitialization(
    ...
    private val expansionStrategy =
        EthereumDepositExpansionStrategy(
            notaryCredential,
            irohaAPI,
            ethDepositConfig
        )

    private val withdrawalProofHandler =
        WithdrawalProofHandler(
