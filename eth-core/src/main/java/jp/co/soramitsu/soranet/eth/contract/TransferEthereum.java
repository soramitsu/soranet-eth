...
public class TransferEthereum extends Contract {
  ...
  @Deprecated
  protected TransferEthereum(String contractAddress, Web3j web3j, Credentials credentials,
  ...
  @Deprecated
  protected TransferEthereum(String contractAddress, Web3j web3j,
  ...
  @Deprecated
  public static TransferEthereum load(String contractAddress, Web3j web3j, Credentials credentials,
      BigInteger gasPrice, BigInteger gasLimit) {
    return new TransferEthereum(contractAddress, web3j, credentials, gasPrice, gasLimit);
  }

  @Deprecated
  public static TransferEthereum load(String contractAddress, Web3j web3j,
      TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
  ...
  public static RemoteCall<TransferEthereum> deploy(Web3j web3j, Credentials credentials,
      ContractGasProvider contractGasProvider) {
  ...
  public static RemoteCall<TransferEthereum> deploy(Web3j web3j,
      TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    return deployRemoteCall(TransferEthereum.class, web3j, transactionManager, contractGasProvider,
        BINARY, "");
  }
  ...
  public static RemoteCall<TransferEthereum> deploy(Web3j web3j,
      TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    return deployRemoteCall(TransferEthereum.class, web3j, transactionManager, gasPrice, gasLimit,
        BINARY, "");
  }
