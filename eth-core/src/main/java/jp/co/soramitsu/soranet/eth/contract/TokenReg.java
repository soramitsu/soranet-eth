...
public class TokenReg extends Contract {
  ...
  @Deprecated
  protected TokenReg(String contractAddress, Web3j web3j, Credentials credentials,
  ...
  @Deprecated
  protected TokenReg(String contractAddress, Web3j web3j, TransactionManager transactionManager,
      BigInteger gasPrice, BigInteger gasLimit) {
  ...
  @Deprecated
  public static TokenReg load(String contractAddress, Web3j web3j, Credentials credentials,
      BigInteger gasPrice, BigInteger gasLimit) {
    return new TokenReg(contractAddress, web3j, credentials, gasPrice, gasLimit);
  }

  @Deprecated
  public static TokenReg load(String contractAddress, Web3j web3j,
  ...
  public static RemoteCall<TokenReg> deploy(Web3j web3j, Credentials credentials,
      ContractGasProvider contractGasProvider) {
  ...
  public static RemoteCall<TokenReg> deploy(Web3j web3j, TransactionManager transactionManager,
      ContractGasProvider contractGasProvider) {
  ...
  public RemoteFunctionCall<Tuple5<String, String, BigInteger, String, String>> token(
      BigInteger _id) {
  ...
  public RemoteFunctionCall<TransactionReceipt> register(String _addr, String _tla,
      BigInteger _base, String _name, BigInteger weiValue) {
  ...
  public RemoteFunctionCall<TransactionReceipt> registerAs(String _addr, String _tla,
      BigInteger _base, String _name, String _owner, BigInteger weiValue) {
    final Function function = new Function(
        FUNC_REGISTERAS,
        Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, _addr),
            new org.web3j.abi.datatypes.Utf8String(_tla),
  ...
  public RemoteFunctionCall<Tuple5<BigInteger, String, BigInteger, String, String>> fromTLA(
      String _tla) {
  ...
  public RemoteFunctionCall<Tuple5<BigInteger, String, BigInteger, String, String>> fromAddress(
      String _addr) {
  ...
  public RemoteFunctionCall<TransactionReceipt> setMeta(BigInteger _id, byte[] _key,
      byte[] _value) {
    final Function function = new Function(
        FUNC_SETMETA,
        Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(_id),
