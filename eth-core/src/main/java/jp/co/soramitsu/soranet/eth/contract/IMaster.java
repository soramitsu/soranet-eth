...
public class IMaster extends Contract {
  ...
  @Deprecated
  protected IMaster(String contractAddress, Web3j web3j, Credentials credentials,
  ...
  @Deprecated
  protected IMaster(String contractAddress, Web3j web3j, TransactionManager transactionManager,
      BigInteger gasPrice, BigInteger gasLimit) {
  ...
  @Deprecated
  public static IMaster load(String contractAddress, Web3j web3j, Credentials credentials,
      BigInteger gasPrice, BigInteger gasLimit) {
    return new IMaster(contractAddress, web3j, credentials, gasPrice, gasLimit);
  }

  @Deprecated
  public static IMaster load(String contractAddress, Web3j web3j,
  ...
  public static RemoteCall<IMaster> deploy(Web3j web3j, Credentials credentials,
      ContractGasProvider contractGasProvider) {
  ...
  public static RemoteCall<IMaster> deploy(Web3j web3j, TransactionManager transactionManager,
      ContractGasProvider contractGasProvider) {
